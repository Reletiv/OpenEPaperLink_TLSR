...
const char *epd_model_string[] = {"NC", "BW213", "BWR213", "BWR154", "213ICE", "BWR350", "BWY350", "BWR266"};
 ...
 void EPD_Display_start(uint8_t full_or_partial)
{
    ...
    //     epd_temperature = EPD_BW_213_ice_Display_start(full_or_partial);
        ...
        epd_temperature = EPD_BWR_266_Display_start(full_or_partial);
    epd_temperature_is_read = 1;
    epd_update_state = 1;
}
 ...
 void EPD_Display_buffer(unsigned char *image, int size)
{
    ...
    //     epd_temperature = EPD_BWY_350_Display_buffer(image, size);
        ...
        EPD_BWR_266_Display_buffer(image, size);
}
 ...
 void EPD_Display_color_change()
{
    if (epd_model == 5)
        ...
        EPD_BWR_213_Display_color_change();
    else if (epd_model == 7)
        EPD_BWR_266_Display_color_change();
}
 ...
 void EPD_Display(unsigned char *image, int size, uint8_t full_or_partial)
{
    ...
    if (epd_model == 1)
        ...
        epd_temperature = EPD_BWR_266_Display(image, size, full_or_partial);
